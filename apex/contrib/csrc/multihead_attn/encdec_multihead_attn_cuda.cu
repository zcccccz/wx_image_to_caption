...
std::vector<torch::Tensor> fwd_cuda(bool use_time_mask, bool is_training,
  ...
  TORCH_CUDABLAS_CHECK(cublasGemmEx(
      ...
      embed_dim, static_cast<const void *>(inputs_q.data_ptr()), CUDA_R_16F,
...
std::vector<torch::Tensor> bwd_cuda(
  ...
  TORCH_CUDABLAS_CHECK(cublasGemmEx(
      ...
      static_cast<void *>(input_q_grads.data_ptr()), CUDA_R_16F, embed_dim,
      CUDA_R_32F,
  ...
  return {input_q_grads, input_kv_grads, input_weight_q_grads,
